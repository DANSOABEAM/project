...
<ul>
    ...
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <button type="submit" name="submit_payroll" class="btn btn-primary">Fetch Payroll</button>
        </form>
        ...
        <?php if ($payroll_result && $payroll_result->num_rows > 0): ?>
            ...
            <table class="table table-bordered payroll-table">
                ...
                <tbody>
                    <?php while ($row = $payroll_result->fetch_assoc()): ?>
                        <tr>
                            <td><?= $row['id']; ?></td>
                            <td><?= number_format($row['salary'], 2); ?> $cent;</td>
            ...
            <button class="btn btn-success print-button" onclick="window.print()">Print Payroll</button>
